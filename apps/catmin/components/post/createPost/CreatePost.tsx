...
const CreatePost = () => {
    ...
    const handleCreatePost = () => {
        ...
        if (slug === '') {
            ...
            showNotification({
                title: 'Slug has been generated from title.',
                message:
                    'Check the slug and click on "create post" once again.',
    ...
    return (
        <div className={styles.container}>
            ...
            <InputWrapper
                label='Title'
                description='Select the title of the post'
                required>
                <Input
                    ...
                    ref={titleField}
                    invalid={dirty}
                    icon={<RiPriceTag3Fill />}></Input>
            </InputWrapper>
            <div>
                <InputWrapper
                    label='Slug'
                    description='Defines the URL of the post. If left empty, the slug will be generated automatically from the title.'>
                    <Input
                        className={styles.input}
                        placeholder='Slug'
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
